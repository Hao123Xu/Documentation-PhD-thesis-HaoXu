...
# mhd to acr
$mhdtoacr filein=/data/id19/bones01/bones3/lea/hao/20200617/G1/0-Seg/volres/vessel/${f}.mhd fileout=${dirint}/${f}.acr format=UCHAR

$SMI2 filein=${dirint}/${f}.acr fileout=${dirslice}/${f}_SMI.xls voxsize=3.5
